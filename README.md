...
If you want to classifiy individual trees in the point cloud, it is recommened to normalize heights to *height above ground elevation* (also done externally).
...
On some Linux platforms (e.g. Ubuntu 16.04) the installation of laspy does not include laszip/laszip-cli.
